...
export { useSyncedStorage as useLocalStorage } from "./synced-storage";

// Legacy local-only hook kept available if a caller doesn't want sync.
export function useLocalOnly<T>(key: string, initial: T): [T, (v: T | ((prev: T) => T)) => void] {
